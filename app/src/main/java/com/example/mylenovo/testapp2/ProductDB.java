...
public class ProductDB extends SQLiteOpenHelper {
    private static final String DATABASE_NAME="MyDatabase_Product.db";
    private static final String TABLE_NAME="Productl";
    ...
    private static final String CREATE_TABLE="CREATE TABLE "+TABLE_NAME+" ("+ID+" INTEGER PRIMARY KEY AUTOINCREMENT, "+
            NAME+" INTEGER NOT NULL, "+TYPE+" VARCHAR(50), "+PRICE_UNIT+" VARCHAR(50) NOT NULL);";
