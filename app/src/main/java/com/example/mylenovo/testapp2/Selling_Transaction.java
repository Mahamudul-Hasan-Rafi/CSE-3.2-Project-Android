...
public class Selling_Transaction extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_selling__transaction);
        ...
        Sold_ItemsDB sold_itemsDB = new Sold_ItemsDB(this);
        Cursor cursor = sold_itemsDB.readAll();
