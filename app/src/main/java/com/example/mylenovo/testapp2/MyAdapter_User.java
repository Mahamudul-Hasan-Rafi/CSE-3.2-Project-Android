...
public class MyAdapter_User extends RecyclerView.Adapter<MyAdapter_User.MyViewHolder> implements Filterable{

    private Context context;
    private List<Upload> uploadList;
    DatabaseReference ref;

    public MyAdapter_User(Context context, List<Upload> uploadList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view = inflater.inflate(R.layout.recycled_item_layout_user, viewGroup, false);
